...
**Note:** If you have not yet completed "[Introduction to Securing a Web API with JWT](/bti425/notes/intro-web-api-security)", please go back and complete it now.  We will be using the secure "simple-API" as a source of data for our App.

If your "simple-API" (from "[Introduction to Securing a Web API with JWT](/bti425/notes/intro-web-api-security)" is not currently running on port 8080, please start it up now. 
...
![Simple App Login Error](/bti425/media/simple-app-login-error-bob.png)
...
![Simple App Vehicles Populated](/bti425/media/simple-app-vehicles-populated.png)
...
![Simple App Nav Unauthenticated](/bti425/media/simple-app-nav-unauthenticated.png)
...
![Simple App Nav Authenticated](/bti425/media/simple-app-nav-authenticated.png)
