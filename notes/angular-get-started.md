...
![Angular CLI web site](/bti425/media/angular-cli-web-site.png)
...
![Server is running](/bti425/media/angular-server-process.png)
...
![New app folder structure](/bti425/media/angular-cli-project-structure-2.png)
